...
import com.tpa.videogames.repositories.RepositorioCategoria;
...
public class ServicioCategoria implements ServicioBase<Categoria> {
    ...
    @Transactional
    public List<Categoria> findByName(String q) throws Exception{
        try{
            List<Categoria> entities = this.repositorio.findByName(q);
            return entities;
        } catch (Exception e) {
            throw new Exception(e.getMessage());
        }
